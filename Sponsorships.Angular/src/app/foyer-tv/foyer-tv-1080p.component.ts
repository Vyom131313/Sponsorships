...
@Component({
    selector: 'foyer-tv-1080p',
    templateUrl: './foyer-tv-1080p.component.html',
    styles: [`
        html, body { overflow:hidden; }
    `],
    styleUrls: ['./foyer-tv-1080p.component.scss'],
    encapsulation: ViewEncapsulation.None,
})
export class FoyerTV1080pComponent implements OnInit {
    ...
    getData() {
        this.busy = this._service.getFoyerData1080P().subscribe(result => {
            console.log(result);
