...
@Component({
    selector: 'sponsorship-weekly-edit',
    templateUrl: './edit.component.html',
})
export class SponsorshipWeeklyEditComponent {
    title: string;
    action: string;
    paramId: number;
    ...
    loadDropDowns() {
        ...
        this.busyLoading = this.raviSabhaService.GetForWeeklySponsorship().subscribe(items => { this.raviSabhaItems = items; });
        this.busyLoading = this.service.GetSponsorshipTypesWeekly().subscribe(items => { this.sponsorshipTypes = items; });
    ...
    onRaviSabhaChange(id: number) {
        console.log("onRaviSabhaChange", id);
        this.vm.RaviSabhaId = id;
    }
