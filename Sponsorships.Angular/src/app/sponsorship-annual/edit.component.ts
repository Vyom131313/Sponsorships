...
@Component({
    selector: 'sponsorship-annual-edit',
    templateUrl: './edit.component.html',
})
export class SponsorshipAnnualEditComponent {
    title: string;
    action: string;
    paramId: number;
    ...
    ngOnInit() {
        ...
        this.title = 'Sponsorship Annual ' + this.action;
    ...
    loadDropDowns() {
        ...
        this.busyLoading = this.service.GetSponsorshipTypesAnnual().subscribe(items => { this.sponsorshipTypes = items; });
